    ...
    public String getImageUrl() {
        return switch (this) {
            case INTERESTED_ANNOUNCEMENT_REMINDER ->
                    "https://github.com/teamterning/Terning-Banner/blob/main/image_scrap.png?raw=true";
            case RECENTLY_POSTED_INTERNSHIP_RECOMMENDATION ->
                    "https://github.com/teamterning/Terning-Banner/blob/main/image_home.png?raw=true";
            case TRENDING_INTERNSHIP_ALERT ->
                    "https://github.com/teamterning/Terning-Banner/blob/main/image_search.png?raw=true";
        };
    }
